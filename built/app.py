...
app = Flask(__name__, static_url_path='/static', static_folder='built/static')
...
def process_text():
    def generate():
        ...
        for i, chunk in enumerate(text_chunks):
            ...
            # Generate audio file
            tts.tts_to_file(text=chunk, speaker_wav=AUDIO_INPUT, language=LANGUAGE, file_path=audio_path)
            ...
            print(f"Sending chunk {i+1}: {result}")  # Debug print
